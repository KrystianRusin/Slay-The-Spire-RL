...
def build_model(observation_space, nb_actions):
    ...
    concatenated = Concatenate()([player_input, card_flatten, deck_lstm, monster_flatten])
    ...
    # Create the model
    model = Model(inputs=[player_input, card_input, deck_input, monster_input], outputs=output)
